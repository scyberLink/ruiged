...
declare class GlobalConfig {
    ...
    addToObject(parentKey: string, key: string, value: string | IAnyObject): any;
    addToObjectFlashData(parentKey: string, key: string, value: string | IAnyObject): IAnyObject;
    addToObjectLocalData(parentKey: string, key: string, value: string | IAnyObject): IAnyObject;
    addToObjectSessionData(parentKey: string, key: string, value: string | IAnyObject): IAnyObject;
    removeFromObject(parentKey: string, keyToRemove: string): any;
    removeFromObjectFlashData(parentKey: string, keyToRemove: string): any;
    removeFromObjectLocalData(parentKey: string, keyToRemove: string): any;
    removeFromObjectSessionData(parentKey: string, keyToRemove: string): any;
