...
declare class DesignElement extends HTMLElement implements IDelegateModel {
    ...
    oncopy: (ev: any) => void;
    addEvent(eventName: string, listener: (e: any) => any): void;
    oncut: (ev: any) => void;
    onpaste: (ev: any) => void;
    ...
    static register(element: typeof DesignElement | typeof HTMLElement): typeof DesignElement | typeof HTMLElement;
